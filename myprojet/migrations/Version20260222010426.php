...
final class Version20260222010426 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ressource_favori ADD CONSTRAINT FK_5C47171FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ressource_interaction ADD CONSTRAINT FK_3EF2DBE4FC6CD52A FOREIGN KEY (ressource_id) REFERENCES ressource (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ressource_favori DROP FOREIGN KEY FK_5C47171FB88E14F');
        $this->addSql('ALTER TABLE ressource_interaction DROP FOREIGN KEY FK_3EF2DBE4FC6CD52A');
