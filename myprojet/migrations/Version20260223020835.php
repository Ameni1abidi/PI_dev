 ...
 */
final class Version20260223020835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chapitre (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(30) NOT NULL, ordre INT NOT NULL, type_contenu VARCHAR(50) NOT NULL, contenu_texte LONGTEXT DEFAULT NULL, contenu_fichier VARCHAR(255) DEFAULT NULL, duree_estimee INT NOT NULL, resume LONGTEXT DEFAULT NULL, cours_id INT NOT NULL, INDEX IDX_8C62B0257ECF78B0 (cours_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(30) NOT NULL, description LONGTEXT NOT NULL, niveau VARCHAR(255) NOT NULL, date_creation DATE NOT NULL, titre_traduit VARCHAR(255) DEFAULT NULL, description_traduit LONGTEXT DEFAULT NULL, badge VARCHAR(20) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE resultat (id INT AUTO_INCREMENT NOT NULL, note NUMERIC(5, 2) NOT NULL, appreciation LONGTEXT DEFAULT NULL, eleve_id INT NOT NULL, examen_id INT NOT NULL, etudiant_id INT NOT NULL, INDEX IDX_E7DB5DE25C8659A (examen_id), INDEX IDX_E7DB5DE2DDEAB1A3 (etudiant_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE resultat ADD CONSTRAINT FK_E7DB5DE2DDEAB1A3 FOREIGN KEY (etudiant_id) REFERENCES utilisateur (id)');
    }
